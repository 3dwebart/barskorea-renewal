<?php
    ...
    // 본문 읽기
    $sql_tmpl = "SELECT notice_yn, notice_yn_text, writer, email, movie_size, movie_id, notice_yn, notice_yn_text, link, html, subject, content, img_align, img_pos
                 FROM `%s` WHERE id=%d";
...
<form method="" action="" enctype="multipart/form-data" class="myform">
	<div class="container">
	    <!-- 글 번호 상태 유지 -->
