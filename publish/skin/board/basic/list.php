...
<script>
    $(function() {
        ...
        $('.list-search-input').on('keypress', function (e) {
			if (e.which == 13) {
...
<?php if ($prev_page > 0) { ?>
        <li class="page-item">
            <a href="index.php?<?php if(empty($bo_name)) { ?>bbs_id=<?php echo($bbs_id); } else { ?>bo_name=<?php echo($bo_name); } ?>&page=<?php echo($prev_page); ?>&search=<?php echo($search); ?>" class="page-link">
                <span aria-hidden="true"><i class="fa fa-caret-left" aria-hidden="true"></i></span></a>
            </li>
<?php } else { ?>
        <li class='page-item disabled'><a href="#" class="page-link">
                <span aria-hidden="true"><i class="fa fa-caret-left" aria-hidden="true"></i></span></a></li>
<?php } ?>
...
?>
        <li class="page-item">
            <a href="index.php?<?php if(empty($bo_name)) { ?>bbs_id=<?php echo($bbs_id); } else { ?>bo_name=<?php echo($bo_name); } ?>&page=<?php echo($i); ?>&search=<?php echo($search); ?>" class="page-link"><?php echo($i); ?></a>
        </li>
<?php
        }
    }
...
<?php if ($next_page > 0) { ?>
        <li class="page-item">
            <a href="index.php?<?php if(empty($bo_name)) { ?>bbs_id=<?php echo($bbs_id); } else { ?>bo_name=<?php echo($bo_name); } ?>&page=<?php echo($next_page); ?>&search=<?php echo($search); ?>" class="page-link">
				<span aria-hidden="true"><i class="fa fa-caret-roght" aria-hidden="true"></i></span>
			</a>
		</li>
<?php } else { ?>
