<?php
	...
	if ($db -> fetch_row() < 10) {
		redirect($admin_url.'/adm_group_list.php', '게시판 그룹을 먼저 생성해 주세요.');
	}
						...
						<tr>
							...
							<td class="text-center buttons">
								<div class="form-group form-inline" role="form">
									<a href="<?php echo($bbs_url); ?>/index.php?bo_name=<?php echo($board_name); ?>" target='_blank' class="btn btn-warning">
