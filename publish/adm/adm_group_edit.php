<?php
	...
	$row = $db -> fetch_array();
?>
	<link rel="stylesheet" href="<?php echo($site_url); ?>/css/validate.css">
	<script type="text/javascript" src="<?php echo($site_url); ?>/plugins/validation/jquery.validate.min.js"></script>
	<script type="text/javascript" src="<?php echo($site_url); ?>/js/admin_board_validate.js"></script>
	<script>
		$(function() {
			...
			<!-- 정보 수정 폼 시작 -->
			<form name="myform" id="myform" class="myform" method="post" action="<?php echo($admin_url); ?>/adm_group_edit_ok.php" role="form"  enctype="multipart/form-data">
				<fieldset>
