<?php
	...
	/** 쎄션 데이더 처리 **/
	//include_once($site_url.'session.php');

	$this_url = post('now_url');
?>
<!DOCTYPE html>
...
<script type="text/javascript">
	$(function() {
		$('.login-btn').click(function() {
			...
			$('.login').attr('action', 'adm_check_ok.php');
			$('.login').submit();
		});
	});
</script>
...
<div class="logo">
	<a href="index.html">
	<img src="<?php echo($site_url); ?>/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<div class="login-form" name="login-form">
		<input type="hidden" name="this_url" value="<?php echo($this_url)?>" />
		<h3 class="form-title">Login to your account</h3>
		<h4><?php echo('This URL = '.$this_url); ?></h4>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="ID" name="adm_id" id="adm_id" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="adm_pw" id="adm_pw" />
			</div>
		</div>
